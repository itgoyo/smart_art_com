...
class WebSite extends BaseService implements IWebSite
{
     ...
     */
    function updateWebSite($title, $logo, $web_desc, $key_words, $web_icp, $web_style_pc, $web_style_admin, $visit_pattern, $web_qrcode, $web_url, $web_phone, $web_email, $web_qq, $web_weixin, $web_address, $web_status, $web_visit,$web_reg,$web_check,$wap_status, $third_count, $close_reason, $web_popup_title = "")
    {
        $data = array(
            'title' => $title,
            'logo' => $logo,
