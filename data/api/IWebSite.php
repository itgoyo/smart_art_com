...
interface IWebsite
{
     ...
     */
    function updateWebSite($title, $logo, $web_desc, $key_words, $web_icp, $web_style_pc,$web_style_admin, $visit_pattern, $web_qrcode, $web_url, $web_phone, $web_email, $web_qq, $web_weixin, $web_address,$web_status,$web_visit,$web_reg,$wap_status,$third_count,$close_reason, $web_popup_title);
     ...
     */
    function addUrlRoute($rule, $route, $is_open, $route_model=1);
    /**
     * 修改伪静态规则
     ...
     */
    function updateUrlRoute($routeid, $rule, $route, $is_open,$route_model=1);
}
