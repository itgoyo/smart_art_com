...
class Goods extends BaseController
{
    ...
    public function goodsDetail()
    {
        ...
        $goods_detail['min_price'] = $goods_sku->where('goods_id',$goods_id)->min('promote_price');
        $goods_detail['max_price'] = $goods_sku->where('goods_id',$goods_id)->max('promote_price');
        ...
        //print_r($goods_attribute_list_new);exit;
        ...
        if ($goods_detail["point_exchange_type"] == 1) {
            $integral_flag ++;
        }
